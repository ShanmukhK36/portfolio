...
export const companies = [
    ...
    },
    {
        ...
        role: 'JAVA Developer',
        responsibilities: ['Architected scalable Spring Boot REST APIs with OAuth 2.0 authentication processing 12,000+ daily transactions on AWS EC2, implementing JUnit/Mockito test suites, integrating with React.js frontend handling 50+ concurrent requests with zero incidents. ','Improved transaction response times by 40% migrating legacy systems to Spring Boot microservices with Redis caching and Hibernate ORM, designing RESTful API contracts with Swagger documentation for React.js TypeScript client applications used by operations staff. ','Engineered scalable backend services handling 10K+ daily financial operations using Java 11 and Spring Boot REST controllers, integrating with Oracle databases and legacy systems while creating Postman API testing suites and technical documentation.','Reduced production release cycles by 40% by implementing Jenkins CI/CD pipelines on AWS with Docker containerization and GitHub automated workflows, enabling 15+ developers to deploy code changes safely with CloudFormation infrastructure-as-code.','Maintained 95% code coverage across microservices by implementing JUnit/Mockito test suites and automated integration testing with Maven, conducting rigorous code reviews and refactoring legacy code that ensured zero production-critical bugs over 6 months.'],
        image: pnc,
        location: 'Arlington, Texas, USA'
    }
]
